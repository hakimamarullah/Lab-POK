.data
	...
	msg2: .asciiz " tahun."
	"MANUAL : Date $3, Bulan $t0, Tahun $t1"
.text
	#tahun acuan
	addi $v1, $zero, 2021
	main:
		li $v0, 4
		la $a0, date #print date request message
		syscall
		
		#take integer input of date
		li $v0, 5
		syscall
		add $t3, $v0, $zero #save date in $t3
		...
		birthOnMarch :
				bgt $t3, 12, notOn12March #check if date of birth before 12 March
